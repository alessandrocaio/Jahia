var $intern_6210 = '<br/>...', $intern_6219 = '<br/>.<br/>.<br/>.', $intern_6209 = '<br/><br/>', $intern_6220 = '<br/><span style="font-style:bold;color:red;">Warning: this will erase the content definitively from the repository<br/>So it will not be displayed anymore anywere<\/span>', $intern_6216 = '<br/><span style="font-style:italic;">', $intern_6221 = 'AsyncLoader5', $intern_6222 = 'DeleteActionItem$1$1', $intern_6223 = 'DeleteActionItem$1$1$1', $intern_6224 = 'DeleteActionItem$1$1$1$1', $intern_6207 = 'Do you really want to remove the selected PAGE {0}?', $intern_6205 = 'Do you really want to remove the {0} selected resources?', $intern_6202 = 'JahiaContentManagementService_Proxy.markForDeletion', $intern_6214 = 'This node is still used by:', $intern_6212 = 'Those nodes are still used in:', $intern_6208 = 'ext-mb-delete-page', $intern_6218 = 'is using this node in page(s)', $intern_6217 = 'label.remove.used', $intern_6203 = 'markForDeletion', $intern_6204 = 'message.remove.multiple.confirm', $intern_6211 = 'message.remove.multiple.usage', $intern_6206 = 'message.remove.single.page.confirm', $intern_6213 = 'message.remove.single.usage', $intern_6215 = 'nodeName', $intern_6201 = 'runCallbacks5';
...
function com_google_gwt_lang_asyncloaders_AsyncLoader5_onLoad__V(){
  ...
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_6201, $intern_1680, -1, -1));
  com_google_gwt_lang_asyncloaders_AsyncLoader5_instance.runCallbacks__V();
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_6201, $intern_1951, -1, -1));
}
...
function org_jahia_ajax_gwt_client_service_content_JahiaContentManagementService_1Proxy_$markForDeletion__Lorg_jahia_ajax_gwt_client_service_content_JahiaContentManagementService_1Proxy_2Ljava_util_List_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_AsyncCallback_2V(this$static, paths, comment, async){
  ...
  !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_1949, evtGroup:statsContext.com_google_gwt_user_client_rpc_impl_RpcStatsContext_requestId, method:$intern_6202, millis:(new Date).getTime(), type:$intern_1680});
  ...
  try {
    ...
    com_google_gwt_user_client_rpc_impl_ClientSerializationStreamWriter_append__Ljava_lang_StringBuffer_2Ljava_lang_String_2V(streamWriter.com_google_gwt_user_client_rpc_impl_ClientSerializationStreamWriter_encodeBuffer, $intern_88 + com_google_gwt_user_client_rpc_impl_AbstractSerializationStreamWriter_$addString__Lcom_google_gwt_user_client_rpc_impl_AbstractSerializationStreamWriter_2Ljava_lang_String_2I(streamWriter, $intern_6203));
    com_google_gwt_user_client_rpc_impl_ClientSerializationStreamWriter_append__Ljava_lang_StringBuffer_2Ljava_lang_String_2V(streamWriter.com_google_gwt_user_client_rpc_impl_ClientSerializationStreamWriter_encodeBuffer, $intern_399);
    ...
    !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_1949, evtGroup:statsContext.com_google_gwt_user_client_rpc_impl_RpcStatsContext_requestId, method:$intern_6202, millis:(new Date).getTime(), type:$intern_2138});
    com_google_gwt_user_client_rpc_impl_RemoteServiceProxy_$doInvoke__Lcom_google_gwt_user_client_rpc_impl_RemoteServiceProxy_2Lcom_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_impl_RpcStatsContext_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_AsyncCallback_2Lcom_google_gwt_http_client_Request_2(this$static, (com_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_$clinit__V() , com_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_VOID), $intern_6202, statsContext, payload, async);
  }
   catch ($e0) {
...
function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_$onSuccess__Lorg_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_2V(this$static){
  ...
  if (!lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.isEmpty__Z()) {
    ...
    for (node$iterator = lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.iterator__Ljava_util_Iterator_2(); node$iterator.hasNext__Z();) {
      ...
      java_util_ArrayList_$add__Ljava_util_ArrayList_2Ljava_lang_Object_2Z(l, com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(node, $intern_2069), 1));
    }
...
function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_$onSuccess__Lorg_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_2Ljava_util_List_2V(this$static, result){
  ...
  if (this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_val$l.java_util_ArrayList_size > 1) {
    ...
    for (node$iterator = this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_val$lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.iterator__Ljava_util_Iterator_2(); node$iterator.hasNext__Z();) {
      ...
      message += $intern_3306 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(node, $intern_540), 1);
      ++i;
    }
  }
  message += $intern_6209;
  ...
  for (j = 0; j < (size > 4?4:size); ++j) {
    ...
    if (java_lang_String_$equals__Ljava_lang_String_2Ljava_lang_Object_2Z(com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6215), 1), n)) {
      message += $intern_6216 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_5776), 1) + $intern_991;
    }
     else {
      message += $intern_6216 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6215), 1) + $intern_107 + org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_6217, $intern_6218) + $intern_3306 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_5776), 1) + $intern_991;
      ++i;
    }
    n = com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6215), 1);
  }
  i > 4 && (message += $intern_6219);
  i > 0 && (message += $intern_3306);
  this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_this$1.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_this$0.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem_permanentlyDelete?(message += org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3803, $intern_6220)):(message += $intern_3306 + org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3826, $intern_3827) + $intern_56);
  box = new com_extjs_gxt_ui_client_widget_MessageBox_MessageBox__V;
  box.com_extjs_gxt_ui_client_widget_MessageBox_title = org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3117, $intern_3118);
  ...
  box.com_extjs_gxt_ui_client_widget_MessageBox_buttons = $intern_1136;
...
_.onApplicationFailure__Ljava_lang_Throwable_2V = function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_onApplicationFailure__Ljava_lang_Throwable_2V(caught){
  $wnd.alert($intern_3720 + caught.getMessage__Ljava_lang_String_2());
}
;
...
function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1$1_$handleEvent__Lorg_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1$1_2Lcom_extjs_gxt_ui_client_event_MessageBoxEvent_2V(this$static, be){
  ...
  if (java_lang_String_$equalsIgnoreCase__Ljava_lang_String_2Ljava_lang_String_2Z(be.com_extjs_gxt_ui_client_event_WindowEvent_buttonClicked.com_extjs_gxt_ui_client_widget_button_Button_text, $intern_1091)) {
...
var com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1lang_1asyncloaders_1AsyncLoader5_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2Ljava_lang_Class_2($intern_4625, $intern_6221), com_google_gwt_lang_ClassLiteralHolder_Lorg_1jahia_1ajax_1gwt_1client_1widget_1toolbar_1action_1DeleteActionItem$1$1_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2Ljava_lang_Class_2($intern_5462, $intern_6222), com_google_gwt_lang_ClassLiteralHolder_Lorg_1jahia_1ajax_1gwt_1client_1widget_1toolbar_1action_1DeleteActionItem$1$1$1_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2Ljava_lang_Class_2($intern_5462, $intern_6223), com_google_gwt_lang_ClassLiteralHolder_Lorg_1jahia_1ajax_1gwt_1client_1widget_1toolbar_1action_1DeleteActionItem$1$1$1$1_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2Ljava_lang_Class_2($intern_5462, $intern_6224);
