var $intern_6192 = '<br/>...', $intern_6201 = '<br/>.<br/>.<br/>.', $intern_6191 = '<br/><br/>', $intern_6202 = '<br/><span style="font-style:bold;color:red;">Warning: this will erase the content definitively from the repository<br/>So it will not be displayed anymore anywere<\/span>', $intern_6198 = '<br/><span style="font-style:italic;">', $intern_6203 = 'AsyncLoader5', $intern_6204 = 'DeleteActionItem$1$1', $intern_6205 = 'DeleteActionItem$1$1$1', $intern_6206 = 'DeleteActionItem$1$1$1$1', $intern_6189 = 'Do you really want to remove the selected PAGE {0}?', $intern_6187 = 'Do you really want to remove the {0} selected resources?', $intern_6184 = 'JahiaContentManagementService_Proxy.markForDeletion', $intern_6196 = 'This node is still used by:', $intern_6194 = 'Those nodes are still used in:', $intern_6190 = 'ext-mb-delete-page', $intern_6200 = 'is using this node in page(s)', $intern_6199 = 'label.remove.used', $intern_6185 = 'markForDeletion', $intern_6186 = 'message.remove.multiple.confirm', $intern_6193 = 'message.remove.multiple.usage', $intern_6188 = 'message.remove.single.page.confirm', $intern_6195 = 'message.remove.single.usage', $intern_6197 = 'nodeName', $intern_6183 = 'runCallbacks5';
...
function com_google_gwt_lang_asyncloaders_AsyncLoader5_onLoad__V(){
  ...
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_6183, $intern_1680, -1, -1));
  com_google_gwt_lang_asyncloaders_AsyncLoader5_instance.runCallbacks__V();
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_6183, $intern_1951, -1, -1));
}
...
function org_jahia_ajax_gwt_client_service_content_JahiaContentManagementService_1Proxy_$markForDeletion__Lorg_jahia_ajax_gwt_client_service_content_JahiaContentManagementService_1Proxy_2Ljava_util_List_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_AsyncCallback_2V(this$static, paths, comment, async){
  ...
  !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_1949, evtGroup:statsContext.com_google_gwt_user_client_rpc_impl_RpcStatsContext_requestId, method:$intern_6184, millis:(new Date).getTime(), type:$intern_1680});
  ...
  try {
    ...
    !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_1949, evtGroup:statsContext.com_google_gwt_user_client_rpc_impl_RpcStatsContext_requestId, method:$intern_6184, millis:(new Date).getTime(), type:$intern_2122});
    com_google_gwt_user_client_rpc_impl_RemoteServiceProxy_$doInvoke__Lcom_google_gwt_user_client_rpc_impl_RemoteServiceProxy_2Lcom_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_impl_RpcStatsContext_2Ljava_lang_String_2Lcom_google_gwt_user_client_rpc_AsyncCallback_2Lcom_google_gwt_http_client_Request_2(this$static, (com_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_$clinit__V() , com_google_gwt_user_client_rpc_impl_RequestCallbackAdapter$ResponseReader_VOID), $intern_6184, statsContext, payload, async);
  }
   catch ($e0) {
...
function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_$onSuccess__Lorg_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_2V(this$static){
  ...
  if (!lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.isEmpty__Z()) {
    ...
    for (node$iterator = lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.iterator__Ljava_util_Iterator_2(); node$iterator.hasNext__Z();) {
      ...
      java_util_ArrayList_$add__Ljava_util_ArrayList_2Ljava_lang_Object_2Z(l, com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(node, $intern_2053), 1));
    }
...
function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_$onSuccess__Lorg_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_2Ljava_util_List_2V(this$static, result){
  ...
  if (this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_val$l.java_util_ArrayList_size > 1) {
    ...
    for (node$iterator = this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_val$lh.org_jahia_ajax_gwt_client_widget_LinkerSelectionContext_multipleSelection.iterator__Ljava_util_Iterator_2(); node$iterator.hasNext__Z();) {
      ...
      message += $intern_3290 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(node, $intern_540), 1);
      ++i;
    }
  }
  message += $intern_6191;
  ...
  for (j = 0; j < (size > 4?4:size); ++j) {
    ...
    if (java_lang_String_$equals__Ljava_lang_String_2Ljava_lang_Object_2Z(com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6197), 1), n)) {
      message += $intern_6198 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_5758), 1) + $intern_991;
    }
     else {
      message += $intern_6198 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6197), 1) + $intern_107 + org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_6199, $intern_6200) + $intern_3290 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_5758), 1) + $intern_991;
      ++i;
    }
    n = com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(com_extjs_gxt_ui_client_data_BaseModelData_$get__Lcom_extjs_gxt_ui_client_data_BaseModelData_2Ljava_lang_String_2Ljava_lang_Object_2(nodeUsage, $intern_6197), 1);
  }
  i > 4 && (message += $intern_6201);
  i > 0 && (message += $intern_3290);
  this$static.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_this$1.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1_this$0.org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem_permanentlyDelete?(message += org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3787, $intern_6202)):(message += $intern_3290 + org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3810, $intern_3811) + $intern_56);
  box = new com_extjs_gxt_ui_client_widget_MessageBox_MessageBox__V;
  box.com_extjs_gxt_ui_client_widget_MessageBox_title = org_jahia_ajax_gwt_client_messages_Messages_get__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2($intern_3101, $intern_3102);
...
_.onApplicationFailure__Ljava_lang_Throwable_2V = function org_jahia_ajax_gwt_client_widget_toolbar_action_DeleteActionItem$1$1_onApplicationFailure__Ljava_lang_Throwable_2V(caught){
  $wnd.alert($intern_3704 + caught.getMessage__Ljava_lang_String_2());
}
;
