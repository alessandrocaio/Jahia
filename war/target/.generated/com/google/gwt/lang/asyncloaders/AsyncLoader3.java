...
public class AsyncLoader3 {
// Callbacks that are pending
private static AsyncLoader3__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader3__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader3 instance = null;
public static void onLoad() {
instance = new AsyncLoader3();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(3);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks3", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks3", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader3__Callback newCallback = new AsyncLoader3__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(3)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(3,
...
while (callbacksHead != null) {
  ...
  AsyncLoader3__Callback next = callbacksHead;
